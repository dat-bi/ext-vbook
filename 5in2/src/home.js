function execute() {
    return Response.success([
        { title: "Q票榜", input: "https://m.qidian.com//majax/rank/yuepiaolist?gender=male&pageNum=1&_csrfToken=JGnNSZdjLQwPn62UnSmFUI3JVNXDQicwhwrKheA0", script: "gen0.js" },
        { title: "Fanqie Tuần", input: "/majax/rank/yuepiaolist?gender=male&pageNum={page}&{_csrfToken}", script: "gen0.js" },
