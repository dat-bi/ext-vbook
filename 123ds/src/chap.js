function execute(url) {
    ...
    url = url.split('///')[0]
    var arl = url.replace('https://www.123ds.org','').replace('https://m.123ds.org','');
    ...
    if(bookName === bookName0){
        ...
        var bookid = brl
        var doc = browser.launch('https://www.123ds.org' + bookid + '.html', 4000)
    }
    ...
    return Response.success(data.replace('本章未完，请点击下一页继续阅读！','').replace('*,转载请注明处：123ds.org 。','').replace('老鹰吃小鸡提醒你：看后求收藏123读书网，接着再看好方便。',''));
}