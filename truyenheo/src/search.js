...
function execute(key, page) { 
    ...
    if (response) {
        ...
        elems.forEach(function(e) {
            var link = e.select('a').attr('href').match(/https:\/\/truyensextv.com\/(.*?)\//g)+""
            data.push({
