...
files.forEach((file) => {
    ...
    data.data.push({
        ...
        "path": "https://raw.githubusercontent.com/dat-bi/ext-vbook/main/" + plugin_detail['metadata']['name'] + "/plugin.zip",
        "version": plugin_detail['metadata']['version'],
        "source": plugin_detail['metadata']['source'],
        "icon": "https://raw.githubusercontent.com/dat-bi/ext-vbook/main/" + plugin_detail['metadata']['name'] + "/icon.png",
