...
function execute(key, page) { 
    ...
    var url = "https://www.google.com/search?q="+key+"+site%3Ahttps%3A%2F%2Ftuoinung.co%2F&sxsrf=ALiCzsa2EDImprPyZ6dPndb3j9RX5ndQ2A%3A1667800234553&ei=qpxoY_aqIbueseMPgf-48A8&ved=0ahUKEwj2p6WEsJv7AhU7T2wGHYE_Dv4Q4dUDCA8&uact=5&oq="+key+"+site%3Ahttps%3A%2F%2Ftuoinung.co%2F&gs_lcp=Cgxnd3Mtd2l6LXNlcnAQA0oECEEYAUoECEYYAFDeBVjeBWDvCGgBcAB4AIABlgGIAZYBkgEDMC4xmAEAoAEBwAEB&sclient=gws-wiz-serp"
    ...
    if (response) {
        ...
        elems.forEach(function(e) {
            var link = $.Q(e, 'a').attr('href').match(/https:\/\/tuoinung.co\/(.*?)\.html/g)+""
            data.push({
                name: $.Q(e, 'h3').text(),
                cover: randomCover(),
                link: link,
